...
module.exports = function (MdepBoundary) {
  const testQuery = require("/loopback-getting-started/common/javascripts/query.js");

  MdepBoundary.mdepBoundGeoJSON = function (query, cb) {
    const dataSource = MdepBoundary.app.datasources.mip;
    const sql = testQuery.mdep_boundary_query;
