...
module.exports = function (RestoLine) {
  const testQuery = require("/loopback-getting-started/common/javascripts/query.js");

  RestoLine.restoLineGeoJSON = function (query, cb) {
    const dataSource = RestoLine.app.datasources.mip;
    const sql = testQuery.resto_line_query;
