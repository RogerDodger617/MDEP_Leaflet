...
module.exports = function (RestoPolygon) {
  const testQuery = require("/loopback-getting-started/common/javascripts/query.js");

  RestoPolygon.restoPolyGeoJSON = function (query, cb) {
    const dataSource = RestoPolygon.app.datasources.mip;
    const sql = testQuery.resto_poly_query;
