...
module.exports = function (RestPolyCentroid) {
  const testQuery = require("/loopback-getting-started/common/javascripts/query.js");

  RestPolyCentroid.restoPolyCentGeoJSON = function (query, cb) {
    const dataSource = RestPolyCentroid.app.datasources.mip;
    const sql = testQuery.resto_poly_centroid_query;
  ...
  RestPolyCentroid.remoteMethod(
    'restoPolyCentGeoJSON',
    {
      http: {verb: 'get'},
