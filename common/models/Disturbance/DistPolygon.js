...
module.exports = function (DistPolygon) {
  const testQuery = require("/loopback-getting-started/common/javascripts/query.js");

  DistPolygon.distPolyGeoJSON = function (query, cb) {
    const dataSource = DistPolygon.app.datasources.mip;
    const sql = testQuery.dist_poly_query;
