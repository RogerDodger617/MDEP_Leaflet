...
module.exports = function (DistPolyCentroid) {
  const testQuery = require("/loopback-getting-started/common/javascripts/query.js");

  DistPolyCentroid.distPolyCentGeoJSON = function (query, cb) {
    const dataSource = DistPolyCentroid.app.datasources.mip;
    const sql = testQuery.dist_poly_centroid_query;
